...
// //             String education=(String) Boxeducation.getSelectedItems();
// //             String designation=tdesignation.getText();
// //             String empID=tempid.getText();

// //             try{
// //                 conn c=new conn();
// //                 String query="insert into employee values('"+name+"','"+fname+"','"+salary+"','"+address+"','"+phone+"','"+email+"','"+education+"','"+designation+"','"+aadhar+"','"+empID+"')";
...
//                 JOptionPane.showMessageDialog(null, "Details added successfully");
//                 setVisible(false);
//                 new Main_class(); // Assuming you have a Main_class to navigate to
